...
# главная функция (первый параметр - картинка в виде массива)
...
def detect_faces_and_predict_age_and_gender(cv2_resized_image, detector, model):
    ...
    # если нашли лица
    if len(detected) > 0:
        # вырезаем области с лицами и запихиваем их в массив с лицами (который faces)
